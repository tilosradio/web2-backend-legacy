...
case 1:
	...
	break;
case 2:
	alert("Név regisztrálása\n\nNick kiválasztásához és arra váltáshoz, majd annak egy jelszó és email segítségével való regisztrálásához az alábbi két sort kell beírnod a bal fenti "Status" fülön, szóköz nélkül az elején, azaz a "/"-jellel kezdve a sorodat:\n\n/nick FELHASZNÁLÓNEVED\n\n/msg nickserv register JELSZAVAD");
	break;
case 3:
