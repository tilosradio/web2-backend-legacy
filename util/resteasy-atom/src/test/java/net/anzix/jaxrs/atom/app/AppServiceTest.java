 ...
 *
 */
package net.anzix.jaxrs.atom.app;

import net.anzix.jaxrs.atom.Category;
import net.anzix.jaxrs.atom.app.AppAccept;
import net.anzix.jaxrs.atom.app.AppCategories;
import net.anzix.jaxrs.atom.app.AppCollection;
import net.anzix.jaxrs.atom.app.AppService;
import net.anzix.jaxrs.atom.app.AppWorkspace;
...
public class AppServiceTest {
    ...
    public void marshallAppService() throws Exception {
        JAXBContext jaxbContext = JAXBContext
                .newInstance("net.anzix.jaxrs.atom.app");
