...
case 1:
	...
	break;
case 2:
	alert("Név regisztrálása\n\nMiután választottál magadnak nick nevet, amit még nem regisztrált senki, akkor sajátodként regisztrálhatod egy jelszóval, hogy a következő belépés alkalmával is tudjad használni.\nAutomatikusan generált nevet nem lehet regisztrálni, illetve természetesen már regisztrált nevet sem.\n\nParancs: /msg NickServ REGISTER <jelszó>\n\nEzzel tudod regisztrálni a nevedet a NickServ adatbázisába. Ha a neved regisztrálva van, akkor tudod használni a SET és az ACCESS parancsokat is, amelyekkel személyre szabhatod a neved beállításait. A megadott jelszót jegyezd meg, mert később szükséged lehet rá, ha változtatni akarsz a beállításaidon. (Figyelj a betűállásra! A JELSZÓ, Jelszó és jelszó mind különböző!)\n\nTanácsok jelszó választáshoz:\nNe használj könnyen megfejthető jelszavakat, például az igazi nevedet. A rövid jelszavak sem biztonságosak, ezért minimum 5 karakter hosszú jelszót kell választanod. A szóköz karakter nem használható a jelszavakban.\n\nEzzel a paranccsal létrehozol egy csoportot is nevedhez, így lehetőséged nyílik arra, hogy további neveket regisztrálj, amelyek beállításai, naplói és a hozzáférési jogai is közösek lesznek a neveddel. További információkért használd a következő parancsot: /msg NickServ HELP GROUP\n\nJelszó változtatás:\n/msg nickserv set password UJJELSZO");
	break;
case 3:
